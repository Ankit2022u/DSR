            ...
            <form action="../api/form_submissions.php" method="post">
                <div class="container px-5 my-5">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-sm-12">
                            <div class="form-floating mb-3">
                                <input class="form-control" id="resultDate" type="date" placeholder="Result Date" name="result_date" required />

                                <!-- Result Date / कयमी दिनांक -->
                                <label for="resultDate">Decision Date / निर्णय दिनांक<span class="required-star">*</span></label>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-sm-12">
                            <div class="form-floating mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-sm-12">
                            <div class="form-floating mb-3">
                                ...
                                <label for="culpritName">Culprit Name / आरोपी का नाम<span class="required-star">*</span></label>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-sm-12">
                            <div class="form-floating mb-3">
                                <input class="form-control" id="culpritAddress" type="text" placeholder="Culprit Address" name="culprit_address" required />
                                <label for="culpritAddress">Culprit Address / आरोपी का पता<span class="required-star">*</span></label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-floating mb-3">
                                <input class="form-control" id="judgementOfCourt" type="text" placeholder="Judgement of Court" name="judgement_of_court" required />
