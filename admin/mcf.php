            ...
            <form action="../api/form_submissions.php" method="post">
                <div class="container px-5 my-5">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-sm-12">
                            <div class="form-floating mb-3">
                                <input class="form-control" id="arrestDate" type="date" placeholder="Arrest Date" name="arrest_date" required />
                                <label for="arrestDate">Arrest Date / गिरफ्तारी का दिनाक<span class="required-star">*</span></label>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-sm-12">
                            <div class="form-floating mb-3">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-12">
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="isItAMajorCrime">Is it a major crime ? / गंभीर अपराध ? </label>
                                </div>
                            </div>
                        </div>
                    </div>
