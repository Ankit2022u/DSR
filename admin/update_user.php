                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="officer_name" class="form-control" value="<?= $user['officer_name']; ?>" required>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        <label for="">Officer Rank</label>
                                                        <input type="text" name="officer_rank" class="form-control" value="<?= $user['officer_rank']; ?>" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select form-select-lg" name="user_type" id="user_type" value="<?= $user['user_type']; ?>" required>
